...
//        charac_data->tbRevData->append("BLE设备-"+Charuuid+"特性值发生变化："+ Value);
    });
...
//        charac_data->tbRevData->append("BLE设备-"+Charname+"特性值读取到的值："+ Value);
    });
...
//        charac_data->tbRevData->append("BLE设备-"+Charname+"特性值成功写入值："+ Value);
    });
    //描述符修改
...
//        charac_data->tbRevData->append("BLE设备-"+Charname+"描述符成功写入值："+ QString(newValue));
    });
    //各种错误信息
